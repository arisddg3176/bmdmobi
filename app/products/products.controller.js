app.controller('productsController', function($scope, $mdDialog, $mdToast, productsFactory){
	...
	$scope.readOneProduct = function(id){
		...
		productsFactory.readOneProduct(id).then(function successCallback(response){
			...
			$scope.bkode = response.data.bkode;
			$scope.bjenis = response.data.bjenis;
			$scope.deskripsi = response.data.deskripsi;
			$scope.jumlah = response.data.jumlah;
			$scope.sumber = response.data.sumber;
			$scope.tahun = response.data.tahun;
			$scope.kondisi = response.data.kondisi;
			$scope.nama_ruang = response.data.nama_ruang;
